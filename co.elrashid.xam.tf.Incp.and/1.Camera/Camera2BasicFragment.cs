...
using co.elrashid.xam.tf.Incp.and.Camera.Listeners;
using Java.IO;
using Java.Lang;
using Java.Util;
...
namespace co.elrashid.xam.tf.Incp.and.Camera
{
    public class Camera2BasicFragment : Fragment, FragmentCompat.IOnRequestPermissionsResultCallback
    {
        ...
        private ImageReader.IOnImageAvailableListener imageListener;
        private int layout;
        ...
        private Camera2BasicFragment(
            ...
            ImageReader.IOnImageAvailableListener imageListener,
            int layout, 
            Size inputSize)
        {
        ...
        public static Camera2BasicFragment newInstance(ConnectionCallback connectionCallback,
            ImageReader.IOnImageAvailableListener imageListener,
            int layout,
            Size inputSize)
        {
            return new Camera2BasicFragment(connectionCallback, imageListener, layout, inputSize);
        }
        ...
        public override void OnViewCreated(View view, Bundle savedInstanceState)
        {
            ...
            mTextureView = (AutoFitTextureView)view.FindViewById(Resource.Id.texture2);
        ...
        #region SetUpCameraOutputs OpenCamera  CloseCamera CreateCameraPreviewSession ConfigureTransform
        ...
        private void SetUpCameraOutputs(int width, int height)
        {
            ...
            try
            {
                for (var i = 0; i < manager.GetCameraIdList().Length; i++)
                {
                    ...
                    if (orientation == Orientation.Landscape)
                    {
                        ...
                        mTextureView.SetAspectRatio(inputSize.Width, inputSize.Height);
                    }
                    else
                    {
                        //////////mTextureView.SetAspectRatio(mPreviewSize.Height, mPreviewSize.Width);
                        mTextureView.SetAspectRatio(inputSize.Height, inputSize.Width);
                    }
            ...
            cameraConnectionCallback.onPreviewSizeChosen(inputSize, mSensorOrientation);
        ...
        public void CreateCameraPreviewSession()
        {
            try
            {
                ...
                texture.SetDefaultBufferSize(inputSize.Width, inputSize.Height);
                ...
                //----------------------------------------
                //   LOGGER.i("Opening camera preview: " + mPreviewSize.Width + "x" + mPreviewSize.Height);

                // Create the reader for the preview frames.
                mImageReader = ImageReader.NewInstance(inputSize.Width, inputSize.Height, ImageFormatType.Yuv420888, 2);
        ...
        public void ConfigureTransform(int viewWidth, int viewHeight)
        {
            ...
            if (null == mTextureView || null == inputSize || null == activity)
            {
                return;
            }
            ...
            RectF bufferRect = new RectF(0, 0, inputSize.Height, inputSize.Width);
            ...
            if ((int)SurfaceOrientation.Rotation90 == rotation || (int)SurfaceOrientation.Rotation270 == rotation)
            {
                ...
                float scale = Math.Max((float)viewHeight / inputSize.Height, (float)viewWidth / inputSize.Width);
